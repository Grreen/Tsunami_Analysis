...
namespace API
{
	...
	rectangle __cdecl make_center(unsigned width, unsigned height);           ///< Retrieves a rectangle which is in the center of the screen.
	...
	void __cdecl close_window(window);
	...
	void __cdecl eat_tabstop(window, bool);
